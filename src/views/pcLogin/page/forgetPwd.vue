<template>
    <div class="register-wrapper">
        <div class="register-title" v-if="!showSuccess">重置密码</div>
        <div class="register-input-list" v-if="!showSuccess">
        ...
        <button v-else @click="toLogin" class="register-btn big-button">
            立即登录
        </button>
        ...
        async register() {
            ...
            if (this.invalidPhoneObj.veriCode.length != 6) {
                ...
                if (!err) {
                    ...
                    console.log(err);
                    this.$message.warning(err.msg || '服务异常')
                }
            }
        },
        /**
